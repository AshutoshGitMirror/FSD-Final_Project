    ...
    <div className="min-h-screen flex font-sans bg-neo-bg">
      ...
      <aside className="w-72 border-r-4 border-black bg-white flex flex-col z-20">
        ...
        <nav className="flex-1 p-6 space-y-4 flex flex-col">
          <Link to="/dashboard/topic"        className={getLinkClass('/topic',        'bg-neo-blue')}>Curriculum Topic</Link>
          <Link to="/dashboard/progress"     className={getLinkClass('/progress',     'bg-neo-pink text-white')}>Progress</Link>
          <Link to="/dashboard/saved-links"  className={getLinkClass('/saved-links',  'bg-neo-yellow')}>Saved YT Links</Link>
